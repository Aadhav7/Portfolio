      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center w-full">
        ...
        >
          ...
          <motion.h1 variants={item} className="text-5xl md:text-7xl font-extrabold mb-4 tracking-tight leading-tight">
            I'm <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#7B2CBF] to-[#9D4EDD]">Aadhavan</span>
            <br />
            Suriyakumaran
          </motion.h1>

          <motion.h2 variants={item} className="text-xl md:text-2xl font-medium text-slate-600 dark:text-slate-400 mb-8">
            Undergraduate <span className="text-[#7B2CBF]">|</span> Information Technology
          </motion.h2>

          {/* ACTION BUTTONS */}
          <motion.div variants={item} className="flex flex-wrap gap-4 justify-center md:justify-start items-center">
            <a
              href="/resume/Aadhavan_Resume.pdf" // Corrected path to match your folder structure
              download="Aadhavan_Suriyakumaran_Resume.pdf"
            ...
            <div className="flex gap-3 ml-2">
              <a 
                href="https://github.com/Aadhav7" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="p-3 rounded-full border border-purple-500 text-purple-500 hover:bg-purple-500 hover:text-white transition-all"
              >
                <FaGithub size={20} />
              </a>
              <a 
                href="https://linkedin.com/in/aadhavan-suriyakumaran-66232237a" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="p-3 rounded-full border border-purple-500 text-purple-500 hover:bg-purple-500 hover:text-white transition-all"
              >
