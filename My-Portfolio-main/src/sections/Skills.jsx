        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <div className="flex items-center gap-4 mb-6 text-[#7B2CBF]">
              <Zap size={32} />
              <h3 className="text-2xl font-bold">UI/UX Design and Development </h3>
            </div>
          ...
          >
            <div className="flex items-center gap-4 mb-6 text-[#7B2CBF]">
              <Monitor size={32} />
              <h3 className="text-2xl font-bold">IT & Relevent Areas</h3>
            </div>
            <motion.ul variants={container} initial="hidden" whileInView="show" className="space-y-3">
              {["LLM Applications", "AI Integration", "LAN, CCTV network Routing and Management", "Mobile and PC Hardware Installation and Maintenance" ,"Automobile Mechanical and Electrical Systems"].map((skill) => (
                <motion.li key={skill} variants={item} className="flex items-center gap-3 text-slate-600 dark:text-slate-400">
                  <span className="h-1.5 w-1.5 rounded-full bg-[#7B2CBF]" /> {skill}
                </motion.li>
              ))}
