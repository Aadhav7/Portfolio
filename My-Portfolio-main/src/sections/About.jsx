...
import { User, GraduationCap,Rocket, Laptop, NetworkIcon, PcCase, Antenna, RouterIcon } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-5 gap-16 items-start">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold mb-8 leading-tight">
              ...
              & <span className="text-[#7B2CBF]">ManKind</span>
            </h2>
            ...
            <div className="grid grid-cols-2 gap-4 mt-12 opacity-50">
              ...
              >
                <NetworkIcon className="text-[#7B2CBF]" size={32} />
              </motion.div>
              <motion.div 
                animate={{ y: [0, 10, 0] }}
              ...
              >
                <RouterIcon className="text-[#7B2CBF]" size={32} />
              </motion.div>
            </div>
          </motion.div>
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            >
              <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 leading-relaxed italic border-l-4 border-[#7B2CBF] pl-6">
                "Driven by a strong interest in technology and software development, I focus on leveraging modern IT solutions to build efficient systems and deliver impactful, real-world applications."
              </p>
              
              <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
              I’m an undergraduate Information Technology student with a strong interest in software development, systems design, and emerging technologies. Currently building a solid foundation through both theoretical learning and hands-on project experience, I focus on understanding how technology solutions are designed, developed, and deployed to solve real-world problems..
              </p>
            </motion.div>

            <div className="grid sm:grid-cols-2 gap-6 pt-8">
              {[
                { icon: <GraduationCap size={28}/>, title: "Education", desc: "HND in Information Technology" },
                { icon: <User size={28}/>, title: "Focus", desc: "LLM and Software Development" }
              ].map((card, i) => (
                <motion.div
                  key={i}
                  custom={i}
