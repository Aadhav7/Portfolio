...
export default function Education() {
  const subjects = [ "Digital Electronics", "Programming Fundamentals", "Data Structures", "AI & Machine Learning Basics", "Computer Networks", "Database Systems", "Software Engineering Principles", "Web Development", "Hardware Maintenance" ];
        ...
        >
          ...
          <div className="bg-slate-50 dark:bg-slate-900/40 backdrop-blur-sm p-8 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-xl hover:shadow-purple-500/10 transition-all">
            <div className="flex flex-wrap justify-between items-start gap-4 mb-6">
              <div>
                <h3 className="text-2xl md:text-3xl font-bold text-[#7B2CBF]">Higher National Diploma in Information Technology (HNDIT)</h3>
                <div className="flex items-center gap-2 mt-2 text-slate-500 dark:text-slate-400">
                  <MapPin size={16} />
                  <span>Sri Lanka Institute of Advanced Technological Education, Jaffna</span>
                </div>
              </div>
            ...
            <p className="text-slate-600 dark:text-slate-300 mb-8 max-w-2xl leading-relaxed">
              Currently in my Final year, focusing on the integration of engineering principles with AI Technology.
            </p>
